...
<html>
	<head>
		...
		.zyjf_child_new{width:1100px;height:auto;margin: 20px auto 0;
		}	
		.zyjf_child_new_con{width: 1100px;height: 100%;margin: 20px auto 40px;padding: 10px 50px;box-shadow: 0px 0px 10px rgb(204, 204, 204);min-height: 450px;background: #ffffff;}
		.child_new_box{width:100%;height: auto;margin: 0 auto;}
		.child_new_box>h3{
			text-align: center;
		}
		.child_new_box>div{
		...
		.child_new_box>p{
			text-indent: 2em;margin: 15px 0;
		}
		</style>
	</head>
	<body>
		<div class="zyjf_child_new">
			<div style="margin-bottom: 15px;"><a href="<?php echo U('Index/index');?>">卓屹金服</a>
				<span> > </span><span class="new_wwl_page"><?php echo ($data['title']); ?></span>
			</div>	
		<div class="zyjf_child_new_con">
			
		<!--新闻页内容-->
		<div class="child_new_box">
			<h3 class="new_title"><?php echo ($data['title']); ?></h3>
			<div><?php echo ($data['tit']); ?></div>
			<div>
				<?php if($data["pic"] != null): ?><img src="/Public<?php echo ($data["pic"]); ?>"><?php endif; ?>
			</div>
			<div>
			&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($data['content']); ?>
			</div>
			<div>
				<?php if($data["vpic"] != null): ?><img src="/Public<?php echo ($data["vpic"]); ?>"><?php endif; ?>
			</div>
