...
<html>
	...
	<head>
		...
		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		<title></title>
		<link rel="stylesheet" type="text/css" href="/Public/zy/js/sucess_case/css.css" />
		<style type="text/css">
			.sucess_case_child {
				width: 100%;
				height: auto;
			...
			.sucess_case_con_child h3 {
				text-align: center;
			}
			
			.child_sucess_case_contain {
				width: 100%;
				height: auto;
			}
			
			.child_sucess_case_contain .title {
				margin-bottom: 15px;
				text-align: center;
				font-size: 24px;
				font-weight: bold;
			...
			.JY1-YUYUE:hover {
				box-shadow: 0px 3px 3px dimgray;
			}
		</style>
	</head>
	...
	<body>
		...
		<div class="sucess_case_child">
			<div class="sucess_case_con_child">
				<h4>您当前的位置<a href="<?php echo U('Index/index');?>">卓屹金服</a> > 成功案例</h4>
				<h3>卓屹金服！我们将为您提供最安全的服务！</h3>

				<!--公共部分开始-->
				<div class="child_sucess_case_contain">
					<div class="title"><?php echo ($gg['title']); ?></div>
					<div class="con">
						<div style="text-indent:30px;"><?php echo ($gg['content']); ?></div>
						<div style="text-indent:30px;"><?php echo ($gg['cont']); ?></div>
					</div>
					<div class="case_yuyue">
						<div class="more_sucess_tg">
							本案例由销售<span>
										<?php if($gg['bu'] == 1): ?>一部
                                        <?php elseif($gg['bu'] == 3): ?>
                                            三部
						...
						<a href="<?php echo U('Jy/daishenqing',array('bu'=>$gg['bu']));?>"><div class="JY1-YUYUE">预约贷款</div></a>
					</div>
				</div>

				<div class="more_sucess_case">
					<a href="<?php echo U('Gs/company_case');?>">更多>></a>
				</div>
				<!--公共部分开始-->
			</div>
		</div>
