            ...
            @endif -->
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="/index.php/Admin/Type/index" method="get"  >
                            ...
                            <form action="<?php echo U('Admin/Type/del');?>" method="post">
                            ...
                            <?php if(is_array($type)): foreach($type as $key=>$value): ?><tr>
                                    ...
                                    <td><img style="width:80px;" src="/Public<?php echo ($value['cover']); ?>"></td>
                                    
                                    <td style="width:100px;"><a href="<?php echo U('Admin/Type/edit',array('id'=>$value['id']));?>"><button type='button' class='btn btn-success' name='sta[]'><i class="fa fa-edit"></i></button></a> <!-- <a href="<?php echo U('Admin/Type/delete',array('id'=>$value['id']));?>"><button type='button' class='btn btn-danger' name='sta[]'><i class="fa fa-trash-o"></i></button></a> --></td>
