...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                评估列表管理
                <small>这是评估列表页面</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> 评估列表管理</a></li>
                <li class="active">评估列表</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">评估列表</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <form action="/index.php/Admin/Pg/index" method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-md-offset-6">
                                        <div class="input-group input-group">
                                            <input value="<?php echo ($_GET['search']); ?>" name="search" type="text" placeholder="手机号" class="form-control">
                                            <span class="input-group-btn">
                            ...
                            <form action="<?php echo U('Admin/Pg/del');?>" method="post">
                            ...
                            <tbody>
                            <?php if(is_array($pg)): foreach($pg as $key=>$value): ?><tr>
                                    ...
                                    <td><?php echo ($value['cheng']); ?></td>
                                    <td><?php echo ($value['xiaoqu']); ?></td>
                                    <td><?php echo ($value['lou']); ?></td>
                                    <td><?php echo ($value['jia']); ?></td>
                                    <td><?php echo ($value['yongtu']); ?></td>
                                    <td><?php echo ($value['leixing']); ?></td>
                                    <td><?php echo ($value['jiegou']); ?></td>
                                    <td><?php echo ($value['huxing']); ?></td>
                                    <td><?php echo ($value['xingshi']); ?></td>
                                    <td><?php echo ($value['chaoxiang']); ?></td>
                                    <td><?php echo ($value['daxiao']); ?></td>
                                    <td><?php echo ($value['cengshu']); ?></td>
                                    <td><?php echo ($value['zongceng']); ?></td>
                                    <td><?php echo ($value['nianfen']); ?></td>
                                    <td><?php echo ($value['price']); ?></td>
                                    <th><?php echo (date("Y年m月d日 H:i:s",$value['time'])); ?></th>
                                    <!-- <td><img src="{<?php echo ($user -> pic); ?>}" width="50" height="50"></td> -->
                                    <td><a href="<?php echo U('Admin/Pg/delete',array('id'=>$value['id']));?>"><button type='button' class='btn btn-danger' name='sta[]'><i class="fa fa-trash-o"></i></button></a></td>
