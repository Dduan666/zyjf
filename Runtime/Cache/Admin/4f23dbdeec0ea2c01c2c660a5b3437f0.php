...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                资讯列表管理
                <small>这是资讯列表页面</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> 资讯列表管理</a></li>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="/index.php/Admin/Notice/index" method="get">
                            ...
                            <form action="<?php echo U('Admin/Notice/del');?>" method="post">
                         
                            <table id="example2" class="table table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th style="width:70px;">ID</th>
                                    <th style="width:100px;">所属资讯</th>
                                    <th style="width:100px;">顶部图片</th>
                                    <th style="width:100px;">尾部图片</th>
                                    <th style="width:100px;">资讯标题</th>
                            ...
                            <tbody>
                            <?php if(is_array($notice)): foreach($notice as $key=>$value): ?><tr>
                                    <td><input type="checkbox" name="like[]" value="<?php echo ($value['id']); ?>"><?php echo ($value['id']); ?></td>
                                    <td>
                                        <?php if(strtoupper($value['team']) == '1'): ?>公司新闻发布
                                        <?php elseif(strtoupper($value['team']) == '2'): ?>
                                        房产资讯
                                        <?php elseif(strtoupper($value['team']) == '3'): ?>
                                        金融资讯<?php endif; ?>
                                    </td>
                                    <td><img style="width:100px;" src="/Public<?php echo ($value['pic']); ?>"></td>
                                    <td><img style="width:100px;" src="/Public<?php echo ($value['vpic']); ?>"></td>
                                    <td><?php echo ($value['title']); ?></td>
                                    <td><?php echo ($value['tit']); ?></td>

                                    <td><?php echo ($value['content']); ?></td>

                                    <td><?php echo ($value['time']); ?></td>

                                    <td><a href="<?php echo U('Admin/Notice/edit',array('id'=>$value['id']));?>"><button type='button' class='btn btn-success' name='sta[]'><i class="fa fa-edit"></i></button></a> <a href="<?php echo U('Admin/Notice/delete',array('id'=>$value['id']));?>"><button type='button' class='btn btn-danger' name='sta[]'><i class="fa fa-trash-o"></i></button></a></td>
