...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                未评估列表管理
                <small>这是未评估列表页面</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> 未评估列表管理</a></li>
                <li class="active">未评估列表</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">未评估列表</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <form action="/index.php/Admin/Ping/index" method="get">
                            ...
                            <form action="<?php echo U('Admin/Ping/del');?>" method="post">
                            ...
                            <tbody>
                            <?php if(is_array($ping)): foreach($ping as $key=>$value): ?><tr>
                                    ...
                                    <td> <a href="<?php echo U('Admin/Ping/delete',array('id'=>$value['id']));?>"><button type='button' class='btn btn-danger' name='sta[]'><i class="fa fa-trash-o"></i></button></a></td>
